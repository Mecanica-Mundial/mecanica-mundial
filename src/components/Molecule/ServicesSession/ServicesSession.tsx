...
export default function ServicesSession({data}: ServicesSessionProps) {
  ...
  return (
    <div className="bg-whiteMundial w-full font-out px-14 md-10:px-20 md-11:px-24 md-12:px-28 md-13:px-40 md-14:px-48 md-15:px-60 l-10:px-10 l-11:px-7 sm-13:px-4" id="services">
