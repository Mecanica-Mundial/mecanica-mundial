...
export default function ContactSession() {
  return (
    <>
      <section className="h-[36.5rem] w-full bg-primary pr-6 pl-6 flex items-center justify-center">
        <div className="w-[63%] h-full flex flex-col gap-6 pr-4 pl-4 pt-4">
          <h1 className="text-4xl font-medium cursor-default">LOCALIZAÇÃO E CONTATOS</h1>
          <div className="w-[35rem] h-96 flex items-center justify-center">
          ...
          <div className="w-[35rem] h-[17rem] flex flex-col items-star justify-center gap-4">
