...
export default function ProductCarosel({ data }: ProductCaroselProps) {
    ...
    return (
        <div className="w-[1215px] l-11:w-[904px] l-12:w-[596px] l-13:w-[288px] relative">
            ...
            <div ref={buttons} className="w-[1265px] l-11:w-[953px] l-12:w-[646px] l-13:w-[338px] justify-between absolute top-[45%] left-[-25px] hidden">
